...
//        if ($$module_name_singular) {
//            $rates = User::with('manager', 'theme')->where('employee_id', $id)->first(['manager_id', 'theme_id', 'k1', 'k2', 'k3', 'k4', 'updated_at']);
//        } else {
...
//        }
        ...
        return view("frontend.$module_name.results", compact('module_name', 'module_name_singular', "$module_name_singular", 'module_icon', 'module_action', 'module_title', 'body_class', 'meta_page_type'));
    }
