        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="float-right">
                    <a href="{{ route("backend.$module_name.profileEdit", $user->id) }}" class="btn btn-primary mt-1 btn-sm" data-toggle="tooltip" title="Edit {{ Str::singular($module_name) }} Profile"><i class="fas fa-wrench"></i> Edit</a>
                </div>
            </div>
            <!--/.col-->
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route("backend.$module_name.changeProfilePassword", $user->id) }}" class="btn btn-outline-primary btn-sm">Change password</a>
                            </td>
                        </tr>
