...
namespace Modules\Employees\Http\Controllers\Backend;
...
//    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = __('labels.backend.customer.name');
    ...
    public function index()
    {
        ...
        $$module_name = $module_model::role('employee')->paginate();

        Log::info("'$title' viewed by User:" . auth()->user()->name . '(ID:' . auth()->user()->id . ')');

        return view(
            "employees::backend.$module_path.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::role('employee')->select('id', 'name', 'username', 'email',  'remainder',   'birthday',  'employeed_to',  'employeed_at', 'email_verified_at', 'updated_at', 'status');
        ...
        return Datatables::of($$module_name)
            ->addColumn('action', function ($data) {
                ...
                return view('employees::backend.includes.user_actions', compact('module_name', 'data'));
            })
...
//            ->editColumn('employeed_at', function ($data) {
//                $module_name = $this->module_name;
////
////                $diff = Carbon::now()->da($data->employeed_at);
//
////                if ($diff < 25) {
////                    return $data->updated_at->diffForHumans();
////                } else {
//                    return $data->employeed_at ? $data->employeed_at->isoFormat('LLLL') : '';
////                }
//            })
//            ->editColumn('employeed_to', function ($data) {
//                $module_name = $this->module_name;
////
////                $diff = Carbon::now()->da($data->employeed_at);
////
...
////                    return $data->updated_at->diffForHumans();
////                } else {
//                return $data->employeed_to ? $data->employeed_at->isoFormat('LLLL') : '';
////                }
//            })
    ...
    public function create()
    {
        ...
        return view(
            "employees::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        $$module_name_singular = $user = $module_model::findOrFail($id);
        $userprofile = Userprofile::where('user_id', $$module_name_singular->id)->first();

        Log::info(label_case($module_title . ' ' . $module_action) . ' | User:' . auth()->user()->name . '(ID:' . auth()->user()->id . ')');

        return view(
            "employees::backend.$module_name.show",
            compact('user', 'module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'userprofile')
        );
    }
    ...
    public function profile(Request $request, $id)
    {
        ...
        return view("employees::backend.$module_name.profile", compact('user','module_name', 'module_name_singular', "$module_name_singular", 'module_icon', 'module_action', 'module_title', 'userprofile'));
    }
    ...
    public function profileEdit($id)
    {
        ...
        return view(
            "employees::backend.$module_name.profileEdit",
            compact('user', 'module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'userprofile')
        );
    }
    ...
    public function profileUpdate(Request $request, $id)
    {
        ...
        return redirect()->route("backend.$module_name.profile", $$module_name_singular->id);
    }
    ...
    public function changeProfilePassword($id)
    {
        ...
        $$module_name_singular = $user = User::findOrFail($id);

        return view("employees::backend.$module_name.changeProfilePassword", compact('user', 'module_name', 'module_title', "$module_name_singular", 'module_icon', 'module_action'));
    }
    ...
    public function changePassword($id)
    {
        ...
        return view(
            "employees::backend.$module_name.changePassword",
            compact('user', 'module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular")
        );
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            "employees::backend.$module_name.edit",
            compact('user','module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular")
        );
    }
...
//        dd($request);
        ...
        $request->validate([
            ...
            'employeed_at' => 'nullable|date',
            'employeed_to' => 'nullable|date',
...
//            'url_linkedin' => 'nullable|min:3|max:191',
    ...
    public function trashed()
    {
        ...
        return view(
            "employees::backend.$module_name.trash",
